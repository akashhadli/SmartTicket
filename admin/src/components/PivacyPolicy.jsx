	...
	return (
		<div>
			...
			<div className='mx-auto pt-24 p-4 max-w-[1024px] text-justify mb-36'>
				...
				<p>
					We value your trust. In order to honour that trust, LekPay adheres to
					ethical standards in gathering, using, and safeguarding any
				...
				<p>
					Powaha Infotech Private Limited (operating under the brandname
					LekPay), is a leading technology company, incorporated in India.
				</p>
				<p>
					<br />
				</p>
				<p>
					This privacy policy governs your use of the application ‘LekPay’
					(“Application”), www . LekPay.com (“Website”) and the other associated
				...
				<p>
					Please read this privacy policy (“<b>Policy</b>”) carefully before
					using the Application, Website, our services and products, along with
					the Terms of Service (“<b>ToS</b>”) provided on the Website. Your use
					of the Website, Application, or services in connection with the
					Application, Website or products (“<b>Services</b>”) shall signify
					your acceptance of this Policy and your agreement to be legally bound
					by the same.
				</p>
				<p>
					<br />
				...
				<p>
					If you do not agree with the terms of this Policy, do not use the
					Website, Application our products or avail any of our Services.
				</p>
				<p>
					<br />
				</p>
				<h1 className='font-semibold text-xl'>User Provided Information</h1>
				<p>
					<br />
				</p>
				<p>
					...
					name, date of birth, email address, location, phone number and
					password; (b) transaction-related information, such as when you make
					...
					Application/Services/products. The said information collected from the
					users could be categorized as “<b>Personal Information </b>”, “
					<b>Sensitive Personal Information </b>” and “
					<b>Associated Information</b>”. Personal Information, Sensitive
					Personal Information and Associated Information (each as individually
					...
					Rules, 2011 (the “<b>Data Protection Rules </b>”)) shall collectively
					be referred to as “<b>Information </b>” in this Policy.
				</p>
				<p>
					<br />
				</p>
				<p>
					...
					provide you with the Services, important information, required notices
					and marketing promotions. We will ask you when we need more
				...
				<p>
					We will not differentiate between who is using the device to access
					the Application, Website or Services or products, so long as the log
					in/access credentials match with yours. In order to make the best use
					of the Application/Website/Services/products and enable your
					Information to be captured accurately on the
					Application/Website/Services/products, it is essential that you have
				...
				<p>
					We will, at all times, provide the option to you to not provide the
					Personal Information or Sensitive Personal Information, which we seek
					...
					Sensitive Personal Information. Such withdrawal of the consent is
					required to be sent in writing to us at the contact details provided
					in this Policy below. In such event, however, the Company fully
				...
				<p>
					...
					mobile device you use, your mobile devices unique device ID, the IP
				...
				<p>
					...
					and services. These companies do not retain, share, store or use
				...
				<p>
					...
					learn about each user&#39;s patterns and movements around the
					...
					improve the Application, products and our Services. We will share your
				...
				<p>
					We may use the individual data and behavior patterns combined with
					personal information to provide you with personalized content, and
					better your long term objectives. Third parties provide certain
					services which we may use to analyze the data and information to
					personalize, drive insights and help us better your experience or
					reach out to you with more value added applications, products,
					information and services. However, these third party companies do not
					have any independent right to share this information. We do not sell,
					...
					so. We may at times provide aggregate statistics about our customers,
					traffic patterns, and related site information to reputable third
					parties, however this information when disclosed will be in an
				...
				<p>
					LekPay will occasionally send email notices or contact you to
				...
				<ul id='l1'>
					...
					<li>
						<p>
							to enforce applicable ToS, including investigation of potential
							violations thereof;
						</p>
					</li>
					<li>
					...
					<li>
						<p>
							...
							of the Application/Website/ Powha Infotech Private Limited or its
				...
				<p>
					...
					is being sent. Some of our features and services may not function
				...
				<h1 className='font-semibold text-xl'>Public Forums</h1>
				<p>
					<br />
				</p>
				<p>
				...
				<h1 className='font-semibold text-xl'>Log information</h1>
				<p>
					<br />
				</p>
				<p>
				...
				<h1 className='font-semibold text-xl'>User communications</h1>
				<p>
					<br />
				</p>
				<p>
				...
				<h1 className='font-semibold text-xl'>Changes to this Statement</h1>
				<p>
					<br />
				</p>
				<p>
				...
				<h1 className='font-semibold text-xl'>Your Consent</h1>
				<p>
					<br />
				</p>
				<p>
					...
					an informed consent prior to providing any Information required for
					the use of the Application/Services/products/Website. By registering
					with us, you are expressly consenting to our collection, processing,
					storing, disclosing and handling of your information as set forth in
					this Policy now and as amended by us. Processing, your information in
					any way, including, but not limited to, collecting, storing, deleting,
				...
				<p>
					Our Grievance team shall undertake all reasonable efforts to address
					your grievances at the earliest possible opportunity.
				</p>
				<p>
					<br />
				</p>
